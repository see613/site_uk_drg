...
<body class="<?=$this->activePage?>-page" id="top">
    ...
    $cs->registerCssFile('/css/styles.css?4');
...
//    $cs->registerScriptFile('/js/Smooth-Div-Scroll/js/jquery-ui-1.10.3.custom.min.js');
//    $cs->registerScriptFile('/js/Smooth-Div-Scroll/js/jquery.mousewheel.min.js');
//    $cs->registerScriptFile('/js/Smooth-Div-Scroll/js/jquery.kinetic.min.js');
//    $cs->registerScriptFile('/js/Smooth-Div-Scroll/js/jquery.smoothdivscroll-1.3-min.js');
