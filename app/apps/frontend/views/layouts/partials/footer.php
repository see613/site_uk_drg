    ...
    <div class="container">
        ...
        <div class="row mb-40">
            ...
            <div class="col-md-8 col-lg-7 center-sm-max">
                ...
                <ul class="services">
                    <li>
                        <span class="bold">SKILLED LOCAL TRADESMEN</span> WITH EXPERT KNOWLEDGE
                    </li>
                    <li>
                        A <span class="bold">FAST AND FRIENDLY</span> SERVICE
                    </li>
                    <li>
                        <span class="bold">NO CALLOUT CHARGE</span> WITHIN NORMAL BUSINESS HOURS
                    </li>
                    <li>
                        DRAIN REPAIR GUY ACCEPTS <span class="bold">CASH</span> OR <span class="bold">CARDS</span>
                    </li>
                    <li>
        ...
        <div class="row mb-25">
            ...
            <div class="col-md-7 right center-sm-max">
                ...
                <p class="font-48 bold" style="line-height: 1.2;">
                    07498291675
                </p>
