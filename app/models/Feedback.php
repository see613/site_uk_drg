...
class Feedback extends CActiveRecord
{
	...
	{
		return array(
            array('name, phone, email, message, allowance', 'required', 'on'=>'send, send-check'),
            array('name, email, message, allowance', 'required', 'on'=>'widget, widget-check'),

            array('name, email, phone', 'length', 'max'=>255),
            array('email', 'email'),
            array('captcha', 'ReCaptchaValidator', 'privateKey'=>RECAPTCHA_PRIVATE_KEY, 'on'=>'widget,send'),

            array('name, phone, email, message, allowance', 'safe'),
